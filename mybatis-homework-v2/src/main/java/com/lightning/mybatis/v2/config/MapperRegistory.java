...
/**
 * Created by James From 咕泡学院出品 老师咨询 QQ 2904270631
 */
public class MapperRegistory {
	...
	public MapperRegistory(String methodQualifiedName, String sqlStatement, Class<?> clazz) {
		methodSqlMapping.put(methodQualifiedName, new MapperData(sqlStatement, Test.class));
	}
